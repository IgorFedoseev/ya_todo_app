...
* Настроен CI на GitHub, включаюший следующие шаги:
  ...
  · загрузка собранного APK-файла в GitHub
  · деплой APK-файла на Firebase App Distribution. 
* К проекту подключён и настроен Firebase Crashlytics, репортинг ошибок работает
* Добавлен Firebase analytics, собирается аналитика по событиям: переходы по экранам; добавление, удаление, выполнение/отмена, редактирование задачи
* Реализована работа с Remote Configs - в зависимости от значения соответствующего параметра меняется цвет важности (цвет чекбокса, воскл. знаков на главной странице и при выборе высокой важности на странице редактирования) с фиолетового на красный по умолчанию
...
https://disk.yandex.ru/d/yU_BvaTTa_EBsg
